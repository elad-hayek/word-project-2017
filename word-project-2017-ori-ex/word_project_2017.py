...
docx_methods_sql_values = [
    "INSERT INTO DOCX_METHODS (NAME,ARGS_NUMBER,FIRST_ARG,SECOND_ARG,THIRD_ARG, FOURTH_ARG, FIFTH_ARG, SIXTH_ARG) \
      VALUES ('write to table', 2,'cell index(row,column)','cell text', null, null, null, null )",
     "INSERT INTO DOCX_METHODS (NAME,ARGS_NUMBER,FIRST_ARG,SECOND_ARG,THIRD_ARG, FOURTH_ARG, FIFTH_ARG, SIXTH_ARG) \
      ...
      VALUES ('add new table' ,2,'number of rows', 'number of columns', null, null, null, null )",
        "INSERT INTO DOCX_METHODS (NAME,ARGS_NUMBER,FIRST_ARG,SECOND_ARG,THIRD_ARG, FOURTH_ARG, FIFTH_ARG, SIXTH_ARG) \
      VALUES ('add new paragraph', 5, 'paragraph text', 'font style(N=none, B=bold, I=italic)', 'font color(B=black, b=blue, G=green, R=red)', 'font size(from 1 to 72)', 'Word font name \ your own font name', null )",
          "INSERT INTO DOCX_METHODS (NAME,ARGS_NUMBER,FIRST_ARG,SECOND_ARG,THIRD_ARG, FOURTH_ARG, FIFTH_ARG, SIXTH_ARG) \
