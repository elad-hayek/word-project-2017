...
DISCONNECT_MESSAGE = GREEN, 'you have been successfully disconnected'
...
actions = {'save doc': Documents.save_doc,
           'add new picture': Documents.add_new_picture,
           'add new table': Documents.add_new_table,
           'write to table': Documents.write_to_table,
           'add new paragraph': Documents.add_new_paragraph,
           'add new heading': Documents.add_new_heading,
           'add new page break': Documents.add_new_page_break,
           'email doc': Documents.email_doc,
           'import existing doc': Documents.import_existing_doc,
           'return to last save': Documents.return_to_last_save,
...
class Server:
    ...
    def get_arguments(self):
        ...
        """
        arguments = \
            self.__server_socket.read_from_client(self.__client_socket)
        return arguments
