...
actions_input = {'add new picture': {'width(in inches)(note that 1 inch = 25.4mm)': PICTURE_SIZE_REGEX}
        ...
        while True:
            ...
            if response:
                ...
                if int(action) == 8 or int(action) == 10 or int(action) == 11:
                    ...
                    color, response_from_server = self.__client_socket.read_from_server()
