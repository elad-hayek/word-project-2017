...
error_messages = {
    ...
    'add new paragraph': ((Fore.LIGHTRED_EX, 'ERROR: there is no such color, action terminated'),
                          ...
                          (Fore.LIGHTRED_EX, 'ERROR: the font size is invalid, action terminated')),
...
confirm_messages = {
    ...
    'return to last save': (Fore.LIGHTGREEN_EX, 'successfully returned to last save'),
    'live docx': (Fore.LIGHTGREEN_EX, 'successfully opend your docx file')}
